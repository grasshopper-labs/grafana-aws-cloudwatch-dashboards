...
validated_dashboards = [
   ...
   "aws-eventbridge/aws-eventbridge.json",
   ...
   "aws-route-53/aws-route-53.json",
   "aws-s3/aws-s3.json",
   "aws-ses/aws-ses.json",
   "aws-sns/aws-sns.json",
   "aws-sqs/aws-sqs.json",
   "aws-step-functions/aws-step-functions.json",
   "aws-storage-gateway/aws-storage-gateway.json",
   "aws-transfer-family/aws-transfer-family.json",
   "aws-transit-gateway/aws-transit-gateway.json",
   "aws-vpn/aws-vpn.json",
   "aws-waf/aws-waf.json",
   "aws-x-ray/aws-x-ray.json",
]
